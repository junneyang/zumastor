...
echo "/var/run/zumastor/mount/testvol slave(rw,fsid=0,no_subtree_check,sync,no_root_squash)" >>/etc/exports
...
${SSH} root@${slave} mount -t nfs4 -o intr,proto=tcp master:/ /mnt
