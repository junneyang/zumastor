...
sleep 10
cd 0.6 && LOCKFILE=/var/run/zbuild/build.lock ./continuous-build.sh >>continuous-build.log 2>&1 </dev/null &
sleep 10
cd 0.6 && ./continuous-install.sh >>continuous-install.log 2>&1 </dev/null &
sleep 10
EOF
